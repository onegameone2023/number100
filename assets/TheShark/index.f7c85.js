System.register("chunks:///_virtual/TheShark", ['./TheShark.Lobby.ts'], function () {
  return {
    setters: [null],
    execute: function () {}
  };
...
System.register("chunks:///_virtual/TheShark.Lobby.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './PhotonClient.ts', './App.ts', './Utils.ts', './TheSharkPhotonClient.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Sprite, Component, PhotonClient, App, Utils, TheSharkPhotonClient;
  return {
    setters: [function (module) {
      ...
      TheSharkPhotonClient = module.TheSharkPhotonClient;
    }],
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4;
      cclegacy._RF.push({}, "e9937amkyJJCZLacD5kg27Y", "TheShark.Lobby", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property,
        menu = _decorator.menu;
      var TheSharkLobby = exports('TheSharkLobby', (_dec = ccclass('TheSharkLobby'), _dec2 = menu('TheShark/Lobby'), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Sprite), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(TheSharkLobby, _Component);
        function TheSharkLobby() {
          var _this;
        ...
        var _proto = TheSharkLobby.prototype;
        _proto.start = function start() {
          var _this2 = this;
          this.photonClient = TheSharkPhotonClient.getInstance();
          ...
          this.photonClient.addResponseListener(PhotonClient.EOperationCodes.Account, function (res) {
            ...
            var IAccountModel = JSON.parse(res.vals[TheSharkPhotonClient.EParameterCodes.LoginResponse]);
        ...
        _proto.dismiss = function dismiss() {
          ...
          TheSharkPhotonClient.getInstance().peer.disconnect();
        };
        return TheSharkLobby;
